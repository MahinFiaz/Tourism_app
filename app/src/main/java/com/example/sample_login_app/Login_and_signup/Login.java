package com.example.sample_login_app.Login_and_signup;

import android.content.Intent;
import android.os.Bundle;

import com.example.sample_login_app.Nevigation_view;
import com.example.sample_login_app.profile;
        ...
        mAuth.signInWithEmailAndPassword(Email,Password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Intent i=new Intent(Login.this,Nevigation_view.class);startActivity(i);
